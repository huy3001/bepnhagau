...
jQuery(document).ready(function($) {
	...
	$('.slide-first-img').imagesLoaded(function() {
		...
		if ( jQuery('.portfolio-slider').length ) {
			jQuery('.portfolio-slider').each(function() {
				var portfolioSlider = jQuery(this),
					portfolioSliderContainer = portfolioSlider.closest('.portfolio-slider-container');
				...
				portfolioSlider.owlCarousel({
					...
					onInitialize: function(){
						if ( portfolioSlider.find('.item').length === 1 ) {
							this.settings.loop = false;
						}
						portfolioSliderContainer.loadImages();
					},
					onInitialized: function(){
						portfolioSliderContainer.removeClass('loading');
					},
					navRewind: false
				});
			});
	...
	if ( jQuery('.brand-category').length ) {
		jQuery('.brand-category').each(function() {
			var productImgSlider = jQuery(this),
				productImgSliderContainer = productImgSlider.closest('.brand-container');
				
  			var itemsNum = Math.min(productImgSlider.find('.owl-item').length, 4);
	...
	if ( jQuery('.gallery-slider').length ) {
		jQuery('.gallery-slider').each(function() {
			var gallerySlider = jQuery(this),
				gallerySliderContainer = gallerySlider.closest('.gallery-container');
				
			gallerySlider.owlCarousel({
				items: 1,
				loop: gallerySlider.children().length > 1,
				dots: false,
				nav: true,
				navText: ['<i class="fa fa-angle-left"><i>','<i class="fa fa-angle-right"><i>'],
				onInitialize: function(){
					...
					gallerySliderContainer.loadImages();
				},
				onInitialized: function(){
					gallerySliderContainer.removeClass('loading');
				},
				navRewind: false
			});
		});
