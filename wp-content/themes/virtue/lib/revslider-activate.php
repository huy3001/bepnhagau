...
function kadence_register_required_plugins() {
	...
	$plugins = array(
		array(
			...
			'source'   				=> 'http://www.kadencethemes.com/ktupdates/api/555153309/revslider.zip', // The plugin source
		...
		array(
			...
			'source'   				=> 'http://www.kadencethemes.com/ktupdates/api/555153309/cyclone-slider-pro.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> 'http://www.kadencethemes.com/ktupdates/api/555153309/kadence-slider.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
	...
	$config = array(
		...
		'strings'      		=> array(
			...
			'notice_can_install_recommended'			=> _n_noop( 'This theme comes packaged with the following premium plugin: %1$s. Plugin is not required.', 'This theme comes packaged with the following premium plugins: %1$s. Plugins are not required.' ), // %1$s = plugin name(s)
