...
<header id="kad-banner" class="banner headerclass kad-header-style-three <?php echo esc_attr($mstickyclass);?>" role="banner" data-header-shrink="1" data-mobile-sticky="<?php echo esc_attr($msticky);?>" data-header-base-height="<?php echo esc_attr($header_height);?>">
          ...
          <div class="<?php echo esc_attr($logocclass); ?> clearfix kad-header-left">
            <div id="logo" class="logocase">
              <a class="brand logofont" style="height:<?php echo esc_attr($header_height);?>px; line-height:<?php echo esc_attr($header_height);?>px; display:block;" href="<?php echo home_url(); ?>/">
                       <?php global $virtue_premium; if (!empty($virtue_premium['x1_virtue_logo_upload']['url'])) { ?> <div id="thelogo" style="height:<?php echo esc_attr($header_height);?>px; line-height:<?php echo esc_attr($header_height);?>px;"><img src="<?php echo esc_url($virtue_premium['x1_virtue_logo_upload']['url']); ?>" alt="<?php  bloginfo('name');?>" style="max-height:<?php echo esc_attr($header_height);?>px" class="kad-standard-logo" />
                         <?php if(!empty($virtue_premium['x2_virtue_logo_upload']['url'])) {?> <img src="<?php echo esc_url($virtue_premium['x2_virtue_logo_upload']['url']);?>" alt="<?php  bloginfo('name');?>" class="kad-retina-logo" style="max-height:<?php echo esc_attr($virtue_premium['x1_virtue_logo_upload']['height']);?>px" /> <?php } ?>
