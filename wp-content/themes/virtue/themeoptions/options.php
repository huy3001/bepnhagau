...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id'=>'kt_slider',
            'type' => 'select',
            'title' => __('If Kadence Slider', 'virtue'), 
        ...
        array(
            ...
            'type' => 'text',
            'title' => __('If Cyclone Slider or using any shortcode', 'virtue'),
    ...
    'fields' => array(
      array(
        ...
        array(
            ...
            'options' => array('none' => __('None', 'virtue'),'flex' => __('Flex Slider', 'virtue'),'rev' => __('Revolution Slider', 'virtue'),'cyclone' => __('Cyclone Slider', 'virtue'), 'video' => __('Video', 'virtue')),
            'default' => 'none',
            'width' => 'width:60%',
        ...
        array(
            ...
            'type' => 'text',
            'title' => __('If Cyclone Slider', 'virtue'),
            'subtitle' => __('Paste Cyclone Slider shortcode here', 'virtue'),
            'required' => array('mobile_switch','=','1'),
            ),
        array(
            'id'=>'home_mobile_slider',
    ...
    'fields' => array(
      ...
      array(
        ...
        array(
            ...
            'options' => array('none' => __('None', 'virtue'),'flex' => __('Flex Slider', 'virtue'),'rev' => __('Revolution Slider', 'virtue'), 'cyclone' => __('Cyclone/Shortcode Slider', 'virtue')),
            'default' => 'none',
            'width' => 'width:60%',
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'info',
            'desc' => __('Portfolio Category Pages', 'virtue'),
            ),
        array(
            'id'=>'portfolio_tax_column',
            'type' => 'slider', 
            'title' => __('Choose how many portfolio columns to show on portfolio catagory pages.', 'virtue'),
            "default"       => "4",
            "min"       => "2",
            "step"      => "1",
            "max"       => "6",
         ...
         array(
            ...
            'type' => 'slider', 
            'title' => __('Choose how many portfolio items show on portfolio catagory pages.', 'virtue'),
            "default"       => "12",
            "min"       => "2",
            "step"      => "1",
            "max"       => "48",
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
      ...
      array(
            ...
            'type' => 'switch', 
            'title' => __('Arrrow navigation for single testimonial post?', 'virtue'),
            "default" => 0,
            ),
        array(
            'id'=>'testimonial_page',
      ...
      array(
        ...
        array(
            ...
            'options' => array('grid' => __('Grid', 'virtue'),'singlecolumn' => __('Single Column', 'virtue')),
            'width' => 'width:60%',
            'default' => 'grid',
            ),
        array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
            array(
                ...
                'subtitle' => __('Turn Off/On all Woocommerce referances and code', 'virtue'),
                "default" => 1,
            ),
            array(
                ...
                'subtitle' => __('Turn Off/On all Portfolio referances and code', 'virtue'),
                "default" => 1,
            ),
            array(
                ...
                'subtitle' => __('Turn Off/On all Staff referances and code', 'virtue'),
                "default" => 1,
            ),
            array(
                'id'=>'kadence_testimonial_extension',
                'type' => 'switch', 
                'title' => __('Testimonail Posts', 'virtue'),
                'subtitle' => __('Turn Off/On all Testimonail referances and code', 'virtue'),
                "default" => 1,
            ),
            array(
...
function kadence_override_redux_icons_css() {
  ...
  wp_register_style('kt-redux-custom-css', get_template_directory_uri() . '/themeoptions/options/css/style.css', false, 330);    
  wp_enqueue_style('kt-redux-custom-css');
  wp_dequeue_style( 'select2-css');
    wp_dequeue_style( 'redux-elusive-icon' );
  wp_dequeue_style( 'redux-elusive-icon-ie7' );
}
add_action('redux-enqueue-virtue_premium', 'kadence_override_redux_icons_css');
